---
name: file-pr
description: File a concise pull request. Use when the user asks to create, file, open, or submit a PR for the current branch.
---
...
GOOD
> ✅ fix(server): reduce bandwidth used by websocket connections
